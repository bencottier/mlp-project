...
# Validation
onmt_translate -model ${EXPDIR}/model${MODEL}_step_${CHECKPOINT}.pt \
               -src data/mathematics_dataset-v1.0/train-easy-split/${TASK}_src_valid.txt 
               -output data/demo/${TASK}/pred_valid_${CHECKPOINT}.txt 
               -replace_unk -verbose
